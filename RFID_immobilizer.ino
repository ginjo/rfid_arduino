 ...
 */
  ...
  void setup() {
    ...
    Led::Beeper = new Led(BEEPER_PIN, "au", S.tone_frequency);
      ...
      LOG(5, F("setup() b4 new objcts, fr"));
      LOG(5, FreeRam(), true);
    #endif
